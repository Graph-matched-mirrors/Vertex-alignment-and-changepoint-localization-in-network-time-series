...
# This file includes results of the simulation on London model for both l2 and l-infinity localizers, we extract l2 results
...
final_errors <- read_csv("../simulation/simulation_results/final_errors_Atlanta3.csv")
